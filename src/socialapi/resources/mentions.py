...
class Mentions:
    """Synchronous mentions resource.

    Provides methods for listing mentions on connected accounts.
    """
    ...
    def list(
        ...
        *,
        ...
        Returns:
            An InteractionsListResponse containing the mentions and count.
...
class AsyncMentions:
    """Asynchronous mentions resource.
